...
*/
pessoa.nomeCompleto() //Olá! Meu nome é Gustavo Miguel da Silva!
...
pessoa.apresentaçao = function()
{
    ...
    {
        var souA = "Olá, eu sou a ";    
    } else
    {
        var souA = "Olá, eu sou o "
    }
    ...
    console.log(souA + pessoa.nome + " " +pessoa.sobrenome + ", tenho " + pessoa.idade + ano + pessoa.altura + ", meu peso é " + pessoa.peso + " e, só hoje, eu já caminhei " + pessoa.caminhouQuantosMetros + metro)
}
